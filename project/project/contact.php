    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-5 mb-5">
                <h5 class="font-weight-semi-bold mb-3">Need help?</h5>
                <p>Liceria & Co Shop is very pleased to support you, please leave us your information. Your request will be processed and responded to as soon as possible.</p>
                <div class="d-flex flex-column mb-3">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>091 234 5678</p>
                </div>
            </div>
        </div>
    </div>
