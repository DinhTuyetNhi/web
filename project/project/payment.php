...
<body>
    ...
    <section class="my-5 py-5">
        ...
        <div class="mx-auto container text-center" style="width: 40%;">
    ...
    <!-- Scripts -->
    <script src="https://www.paypal.com/sdk/js?client-id=AQIRW1BLvBIcBxVEGU1RxfzIpw-7IjS6sWDNGpz8HFzTomm_Kmu80Thk2G6ImBheeimeWspVC79248uK&currency=USD"></script>
    <script>
        paypal.Buttons({
            createOrder: function(data, actions) {
                return actions.order.create({
                    purchase_units: [{
                        amount: {
                            value: '<?php echo $amount; ?>' // Số tiền thanh toán
                        }
                    }]
                });
            },
